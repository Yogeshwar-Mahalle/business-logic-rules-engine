...
import com.ybm.ruleEngine.DSLPatternUtil;
...
public class DSLPatternTest {
    ...
    final String expression1 = "input.salary >= 70000 && input.cibilScore >= 900 && $(loan.interest) >= 8";
    final String expression2 = "$(input.salary) >= 70000 && input.cibilScore >= 900 && $(loan.interest) >= 8";

...
@Component
public class WebSocketContentProcessor implements Processor {
    private static final Logger LOG = LoggerFactory.getLogger(WebSocketContentProcessor.class);
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        LOG.info("*************************** Content processing started ***************************");
        ...
        LOG.info("*************************** Content processing finished ***************************");
    }
}

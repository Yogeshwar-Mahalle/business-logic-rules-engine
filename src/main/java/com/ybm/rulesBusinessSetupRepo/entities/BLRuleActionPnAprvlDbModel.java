...
public class BLRuleActionPnAprvlDbModel implements Serializable {
    ...
    @Column(name = "ASSIGNEE_DATA_OBJECT", length = 64)
    private String assigneeDataObject;
    ...
    @Column(name = "ASSIGNOR_DATA_OBJECT", length = 64)
    private String assignorDataObject;

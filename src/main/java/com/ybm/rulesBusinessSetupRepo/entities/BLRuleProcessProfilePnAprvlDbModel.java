...
@NoArgsConstructor
@Entity
@Table(name = "BL_RULE_PROCESS_PROFILE_PN_APRVL")
@IdClass(BLRuleProcessProfilePnAprvlDbModel.IdClass.class)
public class BLRuleProcessProfilePnAprvlDbModel implements Serializable {

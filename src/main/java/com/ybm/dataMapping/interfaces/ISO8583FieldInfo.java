...
public interface ISO8583FieldInfo extends Cloneable {
    ...
    public enum FormatType {
        MTI, BITMAP, FIXED, LVAR, LLVAR, LLLVAR, YYMM, YYMMDD, DDMMYY, MMDDhhmmss, YYMMDDhhmmss,  CNUMERIC, DNUMERIC, NUMERIC, FLOAT, AMOUNT, STRING, UNKNOWN
    };

    public enum Attribute {

        ALPHA, ALNUM, ALNUMPAD, ALPHA_OR_NUM, NUM, SIGN_NUM, ALNUMSPECIAL, SPECIAL, BIN, NUMERIC, FLOAT, STRING, AMOUNT, UNKNOWN
    };
